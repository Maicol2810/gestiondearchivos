-- Arreglar la función authenticate_user agregando search_path por seguridad
...
BEGIN
  ...
  SELECT (user_record.password_hash = crypt(user_password, user_record.password_hash)) INTO is_password_valid;
