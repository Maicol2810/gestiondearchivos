-- Reemplazar la función authenticate_user para que funcione correctamente con pgcrypto
...
BEGIN
  ...
  -- Verificar la contraseña usando la extensión pgcrypto
  SELECT (user_record.password_hash = public.crypt(user_password, user_record.password_hash)) INTO is_password_valid;
